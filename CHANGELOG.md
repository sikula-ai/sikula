...
### Fixed
- **Automatic Task Preparation**: Task refinement and contract preparation now skip source-code braces in model preambles when locating the single structured JSON response, while still rejecting malformed or multiple JSON objects.
